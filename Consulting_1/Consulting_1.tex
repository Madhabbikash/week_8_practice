...
\begin{figure}
\centering
\includegraphics{Consulting_1_files/figure-latex/histogram-1.pdf}
\caption{\label{fig:histogram}Nice histogram}
\end{figure}

Consider the logNormal data plotted in Figure \ref{fig:histogram}. we are going to use \textcite{ggplot2}
